    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8  md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600 underline">{courseData.educator?.name || courseData.educator}</span>
          </p>
                        ...
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          <div className="flex items-center justify-between w-full text-gray-800 md:text-default">
                            ...
                            <div className="flex gap-2">
                              ...
                              <p>
                                {humanizeDuration(
                                  lecture.calculateDuration * 60 * 1000,
                                  { units: ["h", "m"] }
                                )}
                              </p>
                            </div>
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="flex items-center gap-1">
                <img
                  ...
                  className="w-4 h-4"
                />
                <p>{calculateDuration(courseData)}</p>
              </div>
